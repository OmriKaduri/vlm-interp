...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        max_layer_for_i2t_attn = model_kwargs.pop("max_layer_for_i2t_attn", None)
        image_tokens_mask = model_kwargs.pop('image_tokens_mask',None)
        query_tokens_mask = model_kwargs.pop('query_tokens_mask',None)
        leave_k_highest = model_kwargs.pop('leave_k_highest',None)
        min_token_for_i2t_attn_masking = model_kwargs.pop('min_token_for_i2t_attn_masking',None)
        encoded_past_key_values = model_kwargs.pop("encoded_past_key_values", None)
        block_query = model_kwargs.pop("block_query", None)
        block_query_unidirection = model_kwargs.pop("block_query_unidirection", None)
        block_vis_to_all_from_layer = model_kwargs.pop("block_vis_to_all_from_layer", None)
        block_vis_to_gen_not_between_layers_4_to_20 = model_kwargs.pop("block_vis_to_gen_not_between_layers_4_to_20", None)
        block_vis_to_query_not_between_layers_4_to_20 = model_kwargs.pop("block_vis_to_query_not_between_layers_4_to_20", None)
        block_vis_to_all_not_between_layers_4_to_20 = model_kwargs.pop("block_vis_to_all_not_between_layers_4_to_20", None)
        fastv_ratio = model_kwargs.pop("fastv_ratio", None)
        fastv_layer = model_kwargs.pop("fastv_layer", None)
        
        position_id_offset = model_kwargs.pop("position_id_offset", None)
        
        self._validate_model_kwargs(model_kwargs.copy())
        model_kwargs['max_layer_for_i2t_attn'] = max_layer_for_i2t_attn
        model_kwargs['image_tokens_mask'] = image_tokens_mask
        model_kwargs['query_tokens_mask'] = query_tokens_mask
        model_kwargs['leave_k_highest'] = leave_k_highest
        model_kwargs['min_token_for_i2t_attn_masking'] = min_token_for_i2t_attn_masking
        model_kwargs['encoded_past_key_values'] = encoded_past_key_values
        model_kwargs['block_query'] = block_query
        model_kwargs['block_query_unidirection'] = block_query_unidirection
        model_kwargs['block_vis_to_all_from_layer'] = block_vis_to_all_from_layer
        model_kwargs['block_vis_to_gen_not_between_layers_4_to_20'] = block_vis_to_gen_not_between_layers_4_to_20
        model_kwargs['block_vis_to_query_not_between_layers_4_to_20'] = block_vis_to_query_not_between_layers_4_to_20
        model_kwargs['block_vis_to_all_not_between_layers_4_to_20'] = block_vis_to_all_not_between_layers_4_to_20
        model_kwargs['fastv_ratio'] = fastv_ratio
        model_kwargs['fastv_layer'] = fastv_layer
        model_kwargs['position_id_offset'] = position_id_offset
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        fastv_layer = model_kwargs.pop('fastv_layer',None)
        fastv_ratio = model_kwargs.pop('fastv_ratio',None)
        first_iter_and_from_cache = True if len(input_ids[0])>0 else False
        ...
        while True:
            ...
            model_inputs = self.prepare_inputs_for_generation(input_ids, **model_kwargs, first_iter_and_from_cache=first_iter_and_from_cache)
            #TODO: OMRI - following lines
            model_inputs['max_layer_for_i2t_attn'] = max_layer_for_i2t_attn
            model_inputs['image_tokens_mask'] = image_tokens_mask
            model_inputs['leave_k_highest'] = leave_k_highest
            model_inputs['min_token_for_i2t_attn_masking'] = min_token_for_i2t_attn_masking
            model_inputs['block_query'] = block_query
            model_inputs['block_query_unidirection'] = block_query_unidirection
            model_inputs['block_vis_to_all_from_layer'] = block_vis_to_all_from_layer
            model_inputs['block_vis_to_gen_not_between_layers_4_to_20'] = block_vis_to_gen_not_between_layers_4_to_20
            model_inputs['block_vis_to_query_not_between_layers_4_to_20'] = block_vis_to_query_not_between_layers_4_to_20
            model_inputs['block_vis_to_all_not_between_layers_4_to_20'] = block_vis_to_all_not_between_layers_4_to_20
            model_inputs['first_iter_and_from_cache'] = first_iter_and_from_cache
            model_inputs['fastv_layer'] = fastv_layer
            model_inputs['fastv_ratio'] = fastv_ratio
            ...
            if this_peer_finished and not synced_gpus:
                break
            first_iter_and_from_cache = False
